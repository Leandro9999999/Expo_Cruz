        ...
        {!seleccionado ? (
          ...
          >
            <button
              ...
              className="mb-6 self-start text-sm font-bold uppercase tracking-[0.1em] text-zinc-400 transition-colors duration-150 hover:text-white"
            >
              ← VOLVER A PRODUCTOS
            </button>
            ...
            <motion.section
              ...
              transition={{ duration: 0.18 }}
              className="relative w-full max-w-5xl rounded-[2rem] border border-white/10 bg-black/30 p-6 sm:p-10 md:p-12 backdrop-blur-md shadow-2xl overflow-hidden"
            >
              <div className="grid w-full grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-12">
                ...
                <div className="flex flex-col space-y-6 text-left">
                  ...
                  <a
                    ...
                    className="inline-flex w-fit items-center justify-center gap-3 rounded-xl bg-emerald-600 px-5 py-3 text-xs font-extrabold uppercase tracking-widest text-white shadow-lg shadow-emerald-950/40 transition-colors duration-150 hover:bg-emerald-500"
                  >
                    <Image
                      ...
                      (manual, indice) =>
                        manual ? (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-xs font-bold uppercase tracking-widest text-white backdrop-blur-sm transition-colors duration-150 hover:bg-white/10"
                          >
                            <Image
                              src="/icon/pdf.png"
                              alt="PDF"
                    ...
                    {seleccionado.imagenes.length > 1 && (
                      <>
                        <button
                          ...
                          className="absolute left-3 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-black/40 text-lg font-bold text-white transition-colors duration-150 hover:bg-black/80"
                        >
                          ‹
                        </button>
                        <button
                          ...
                          className="absolute right-3 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-black/40 text-lg font-bold text-white transition-colors duration-150 hover:bg-black/80"
                        >
                          ›
                        </button>
                      </>
                    ...
                    <div className="flex w-full justify-center gap-3 overflow-x-auto p-2">
                      {seleccionado.imagenes.map((imagen, indice) => (
                        <button
                          ...
                          className={`relative h-16 w-16 shrink-0 overflow-hidden rounded-xl border-2 bg-white transition-all duration-150 ${
                            indiceImagen === indice
        ...
        {modalAbierto && seleccionado && (
          ...
          >
            <button
              ...
              className="absolute right-6 top-6 z-20 p-2 text-3xl font-bold text-white/70 transition-colors duration-150 hover:text-white"
            >
              ×
            </button>
            ...
            <motion.div
              ...
              className="relative h-[70vh] w-full max-w-4xl rounded-[2rem] bg-white p-6 shadow-2xl sm:h-[80vh] sm:p-10"
            >
              <Image
                src={seleccionado.imagenes[indiceImagen]}
                alt={seleccionado.titulo}
